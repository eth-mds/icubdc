...
```{tikz, fig.cap = "A graphical representation of how a hypoglycemic event might occur in the ICU.", fig.ext = "png", echo = FALSE, fig.align = "center", engine.opts=list(extra.preamble = c("\\usepackage{arrows}", "\\usepackage{patterns}", "\\usepackage{decorations.pathreplacing}"))}
