...
```{tikz, fig.cap = "A graphical representation of how a sepsis-3 onset might occur in the ICU.", fig.ext = "png", echo = FALSE, fig.align = "center", fig.width = 14, engine.opts=list(extra.preamble = c("\\usepackage{arrows}", "\\usepackage{patterns}", "\\usepackage{decorations.pathreplacing}"))}
